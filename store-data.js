...
export const INTEGRATIONS={apiBaseUrl:'/api',ordersEndpoint:'/orders',useLiveOrderApi:false,whatsapp:{enabled:true,phone:'919999999999'},instagram:{enabled:false,url:'https://instagram.com/yourstore'},googleMaps:{enabled:true,url:'https://maps.google.com/?q=123+Main+Market+Road'},payment:{enabled:false,provider:'razorpay'}};
